...
exports.ttsPreprocessor = exports.TTSPreprocessor = void 0;
    ...
    preprocess(text, maxWords = 30) {
        ...
        cleaned = cleaned.replace(/(?:₹|Rs\.?\s*)([0-9,]+)/gi, (_, priceStr) => {
            ...
            if (!isNaN(numericPrice)) {
                return (0, pricingService_1.numberToWordsRupees)(numericPrice);
            }
            return priceStr;
        });
        ...
        cleaned = cleaned.replace(/\b(\d+)\b/g, (match, numStr) => {
            ...
            if (n >= 1000 && n <= 999999) {
                return (0, pricingService_1.numberToWordsRupees)(n);
            }
            return match;
        });
...
exports.TTSPreprocessor = TTSPreprocessor;
exports.ttsPreprocessor = new TTSPreprocessor();
