...
export class AnalyticsService {
  public getAnalyticsSummary(merchantId?: string): AnalyticsSummary {
    const logs = callLogService.getCallLogs(merchantId);
    const evals = evalService.getResults(merchantId);
