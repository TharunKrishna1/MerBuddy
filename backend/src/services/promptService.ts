import { PromptTemplate, HygieneWarning, Merchant } from '../types';
import { mockPrompts } from '../data/mockPrompts';

export class PromptService {
  private prompts: PromptTemplate[] = [...mockPrompts];

  public getAllPrompts(merchantId?: string): PromptTemplate[] {
    if (merchantId) {
  ...
  public savePrompt(promptData: Partial<PromptTemplate>): PromptTemplate {
   ...
   */
  public validatePromptHygiene(content: string, variables: string[]): HygieneWarning[] {
